import client from "../db/jaideep_db.js";
// const sendEmail = require(`${PROJECT_DIR}/utility/sendEmail`);
...
export const getReportjaideep = async (req, res) => {
  try {
...
// export const getUsersA = async (req, res) => {
//   try {
//     const result = await poolA.query("SELECT * FROM salesforce.custom_order__c where sfid is null");
